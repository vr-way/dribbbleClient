...
//        if segmentalFlag == 1 {
//             fetchLikes(userNick: userNickname, page: 1)
//        }
...
//       return flag == 0 ? tableView.dequeueReusableCell(withIdentifier: Const.identifierFollowers, for: indexPath) : tableView.dequeueReusableCell(withIdentifier: Const.identifierLikes, for: indexPath)
//        
    ...
    func setDataBio(){
        ...
        UserDS.getUser(userNickname){ apiData, user in
